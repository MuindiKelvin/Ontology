...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					...
					<a href="test/test_RdqlQuery.php"><i class="icon fa fa-shopping-search"></i>SPARQL Queries</a>
					<a href="test/test_SerializerOptions.php"><i class="icon fa fa-shopping-search"></i>XML/RDF Files</a>
